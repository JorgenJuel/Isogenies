...
## Start curve which has left order I.right_order() and unknown right order

IndexOfIsogenies = [0,4,1,0,1,5]
start_curve = EllipticCurve(field, [163, 400])
target_curve = EllipticCurve(field, [332*w + 40, 208*w+6])